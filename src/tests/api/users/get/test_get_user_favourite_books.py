    ...
    with session_maker() as session:
        ...
        users = [
            User(
                ...
                favourite_books=[
                    FavouriteBook(book=book1, added_ts="2025-07-02T10:23:54"),
                    FavouriteBook(book=book2, added_ts="2025-03-02T10:23:54"),
                ]
            ),
            User(
                id=2,
                ...
                favourite_books=[
                    FavouriteBook(book=book2, added_ts="2025-06-02T10:23:54")
                ]
            ),
            User(
                id=3,
                ...
                favourite_books=[
                    FavouriteBook(book=book1, added_ts="2025-05-02T10:23:54")
                ]
            ),
            User(
                id=4,
                ...
                favourite_books=[
                    FavouriteBook(book=book3, added_ts="2025-01-02T10:23:54")
                ]
            )
        ]
...
@pytest.mark.parametrize(
    ...
    [
        (1, ["Преступление и наказание", "Игрок"], ["2025-07-02T10:23:54", "2025-03-02T10:23:54"]),
        (2, ["Игрок"], ["2025-06-02T10:23:54"]),
        (3, ["Преступление и наказание"], ["2025-05-02T10:23:54"]),
        (4, ["Анна Каренина"], ["2025-01-02T10:23:54"]),
    ]
)
def test_get_user_favourite_books(user_id, expected_books: list[str], expected_ts: list[str]):
