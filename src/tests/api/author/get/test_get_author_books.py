    ...
    with session_maker() as session:
        authors = [
            Author(
                ...
                books=[
                    Book(id=1, title="Преступление и наказание", year_written="1866-01-01"),
                    Book(id=2, title="Игрок", year_written="1866-01-01"),
            ...
            Author(
                ...
                name="Лев Толстой",
                books=[
                    Book(id=4, title="Война и мир", year_written="1869-01-01"),
                    Book(id=5, title="Анна Каренина", year_written="1877-01-01")
                ]
            ),
            Author(
                id=3,
                name="Антон Чехов",
                books=[
                    Book(id=6, title="Вишневый сад", year_written="1904-01-01")
                ]
            ),
            Author(
                id=4,
